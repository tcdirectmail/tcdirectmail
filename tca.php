...
$TCA["tx_tcdirectmail_targets"] = Array (
	...
	"targettype" => Array (
		...
		'type' => 'select',
		'items' => array(
		    array('LLL:EXT:tcdirectmail/Lang/locallang_db.xlf:tx_tcdirectmail_targets.optbeusers', 'Tcdirectmail\\Tcdirectmail\\Target\\BeusersTarget'),
		    array('LLL:EXT:tcdirectmail/Lang/locallang_db.xlf:tx_tcdirectmail_targets.optfegroups', 'Tcdirectmail\\Tcdirectmail\\Target\\FeusersFromGroupsTarget'),
		    array('LLL:EXT:tcdirectmail/Lang/locallang_db.xlf:tx_tcdirectmail_targets.optfepages', 'Tcdirectmail\\Tcdirectmail\\Target\\FeusersFromPagesTarget'),
		    array('LLL:EXT:tcdirectmail/Lang/locallang_db.xlf:tx_tcdirectmail_targets.optttaddress', 'Tcdirectmail\\Tcdirectmail\\Target\\TtaddressTarget'),
		    array('LLL:EXT:tcdirectmail/Lang/locallang_db.xlf:tx_tcdirectmail_targets.optcsvfile', 'Tcdirectmail\\Tcdirectmail\\Target\\CsvFileTarget'),
		    array('LLL:EXT:tcdirectmail/Lang/locallang_db.xlf:tx_tcdirectmail_targets.optcsvlist', 'Tcdirectmail\\Tcdirectmail\\Target\\CsvListTarget'),
		    array('LLL:EXT:tcdirectmail/Lang/locallang_db.xlf:tx_tcdirectmail_targets.optcsvurl', 'Tcdirectmail\\Tcdirectmail\\Target\\CsvUrlTarget'),
		    array('LLL:EXT:tcdirectmail/Lang/locallang_db.xlf:tx_tcdirectmail_targets.opthtml', 'Tcdirectmail\\Tcdirectmail\\Target\\HtmlTarget'),
		    ),
		'size' => 1,
		'maxitems' => 1,
	    ),
